...
export default function Experience() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/3 -translate-x-1/2 w-[600px] h-[600px] bg-purple-600/10 blur-[170px] rounded-full pointer-events-none" />
      <div className="absolute bottom-1/4 right-10 w-[450px] h-[450px] bg-blue-600/10 blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute top-10 right-1/4 w-[350px] h-[350px] bg-cyan-500/10 blur-[130px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/15 backdrop-blur-md text-xs sm:text-sm font-medium text-purple-300 shadow-inner">
          ...
          {experienceCards.map((card) => (
            ...
            >
              ...
              <div className="space-y-4 relative z-10">
                ...
                {/* Duration */}
                <div className="inline-flex items-center gap-1.5 text-xs text-slate-400 bg-white/5 px-3 py-1 rounded-md border border-white/10">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {card.tech.map((techItem, index) => (
                    <span
                      key={index}
                      className="text-xs px-2.5 py-1 rounded-md bg-purple-950/50 border border-purple-500/30 text-purple-200 font-medium"
                    >
                      {techItem}
                    </span>
                  ))}
              ...
              <div className="pt-6 mt-6 border-t border-white/10 relative z-10 flex items-center justify-between">
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-purple-300 hover:text-cyan-300 font-semibold text-xs tracking-wider uppercase transition-colors group/link"
                >
